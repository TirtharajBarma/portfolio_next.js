...
const Project = () => {
  return (
    <div id='project' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        <div className="grid gap-5 my-10" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))' }}>
